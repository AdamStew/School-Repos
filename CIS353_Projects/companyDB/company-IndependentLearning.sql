...
*/
SELECT *
FROM (SELECT E.SALARY, RANK() OVER (ORDER BY E.SALARY) AS RANK
      FROM Employee E)
WHERE SALARY = 30000;
--
...
*/
SELECT *
FROM (SELECT RANK(31000) WITHIN GROUP (ORDER BY E.SALARY) "Rank of $31000"
      FROM Employee E);
--
...
*/
SELECT *
FROM (SELECT E.SALARY, DENSE_RANK() OVER (ORDER BY E.SALARY) AS RANK
      FROM Employee E)
WHERE SALARY = 30000;
-- 
...
*/
SELECT *
FROM (SELECT DENSE_RANK(31000) WITHIN GROUP (ORDER BY E.SALARY) "Rank of $31000"
      FROM Employee E);
--
...
CONNECT BY E.SSN = PRIOR E.SUPER_SSN
ORDER SIBLINGS BY E.SSN;
---------------------------------------------------------------
SET ECHO OFF
SPOOL OFF
